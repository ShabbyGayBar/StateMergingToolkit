...
base_game_dir = {
    ...
    "Pops": r"StateMergingToolkit/mod",
}
...
mod_dir = {
    ...
    "Pops": r"StateMergingToolkit/output",
}

mod_state = ModState(base_game_dir, mod_dir)

pops = mod_state.get_data("Pops")
...
# Write data to json
with open(mod_dir["Pops"]+"/all_pops.json", "w", encoding="utf-8") as file:
    json.dump(pops["POPS"], file, ensure_ascii=False, indent=4)
